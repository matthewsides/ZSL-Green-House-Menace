...
The Overall goal of the project was to design,present and create a demo of an application based around (ZSL's Specifications) the Green house gas chain, production and impact on the envirioment, essentialy satisfying the clients needs. This is required to be completed by __ based on whenthe event is scehduled. whilst the milestones that are required to be completed along the way in order to meet said goal consist of :
